...
export default class RequestControllers {
  ...
  postDataTo = (endpoint: string, data: unknown, option?: AxiosRequestConfig) =>
    this.instance.post(endpoint, data, option);

  putDataTo = (endpoint: string, data: unknown, option?: AxiosRequestConfig) =>
    this.instance.put(endpoint, data, option);

  patchDataTo = (endpoint: string, data: unknown, option?: AxiosRequestConfig) =>
